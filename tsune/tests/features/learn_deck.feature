Feature: Learn Deck
  ...
  Scenario: Open edit card dialog from within learning dialog
    Given I am in the learning dialog for the deck "Datenbanken"
    And I see the back of a card
    When I click on the button "Bearbeiten"
